...
for i, file in enumerate(files):
    if file.endswith('jpg') or file.endswith('png'):
        ...
        # 第一个局部放大图
        # pt1 = (220, 120)  # 长方形框左上角坐标
        # pt2 = (290, 140)  # 长方形框右下角坐标
        pt1 = (220, 120)  # 长方形框左上角坐标
        pt2 = (290, 140)  # 长方形框右下角坐标
        # pt1 = (220, 120)
        # pt2 = (290, 140)
        # cv2.rectangle(image, pt1, pt2, (179, 138, 65), 2)
        cv2.rectangle(image, pt1, pt2, (0, 69, 255), 2)
        # patch1 = image[120:140, 220:290, :]
        patch1 = image[120:140, 220:290, :]
        ...
        # 第三个局部放大图
        pt3 = (300, 200) # 长方形框左上角坐标
        pt4 = (370, 220) # 长方形框右下角坐标
        # pt3 = (300, 200)
        # pt4 = (370, 220)
        # cv2.rectangle(image, pt3, pt4, (12, 92, 232), 2)
        # cv2.rectangle(image, pt3, pt4, (0, 69, 255), 2)
        cv2.rectangle(image, pt3, pt4, (0, 200, 0), 2)
        # patch3 = image[200:220, 300:370, :]
        patch3 = image[200:220, 300:370, :]
